...
id_to_pattern = {
    'A': LinearTrendPattern(base=200, slope=1.05),
    ...
    'H': FeedbackLoopPattern(base=150, feedback_rate=0.02),
...
if __name__ == "__main__":
    ...
    df = simulate_traffic(id_to_pattern, start_time, days=7, output_format="csv", out_file="traffic.csv")
    print("Simulation completed and saved to 'traffic.csv'")
